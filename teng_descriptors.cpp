...
// *************** Descriptor Set Layout *********************
    ...
    DescriptorSetLayout::DescriptorSetLayout(
        Device &lveDevice, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings) : lveDevice{lveDevice}, bindings{bindings} {
...
// *************** Descriptor Writer *********************
    ...
    DescriptorWriter &DescriptorWriter::writeBuffer(
        ...
        // NOTE: Had to change setLayout.bindings to getBindings()
